...
Project by [http://gleuch.com Greg Leuch] and [http://theowatson.com Theo Watson].
...
* Goto your settings and make sure you have Geotagging enabled.
* Create a new trip in the database. (Coming soon, in meantime, use MySQL database.)
