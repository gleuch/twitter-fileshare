...
* Rename the settings.yml.default to settings.yml and the config.sample.ru to config.ru. (Minor changes may need to be made to config.ru for your server setup.)
